...
export class ConductorCalificacionClienteController {
  ...
  async find(
    ...
    return this.conductorRepository.calificacionClientes(id).find(filter);
  }
  ...
  async create(
    ...
    return this.conductorRepository.calificacionClientes(id).create(calificacionCliente);
  }
  ...
  async patch(
    ...
    return this.conductorRepository.calificacionClientes(id).patch(calificacionCliente, where);
  }
  ...
  async delete(
    ...
    return this.conductorRepository.calificacionClientes(id).delete(where);
  }
}
