...
export class ConductorCalificacionConductorController {
  ...
  async find(
    ...
    return this.conductorRepository.calificacionConductors(id).find(filter);
  }
  ...
  async create(
    ...
    return this.conductorRepository.calificacionConductors(id).create(calificacionConductor);
  }
  ...
  async patch(
    ...
    return this.conductorRepository.calificacionConductors(id).patch(calificacionConductor, where);
  }
  ...
  async delete(
    ...
    return this.conductorRepository.calificacionConductors(id).delete(where);
  }
}
