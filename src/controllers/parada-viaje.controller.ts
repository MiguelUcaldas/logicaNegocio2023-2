...
export class ParadaViajeController {
  ...
  async find(
    ...
    return this.paradaRepository.viajes(id).find(filter);
  }
  ...
  async create(
    ...
    return this.paradaRepository.viajes(id).create(viaje);
  }
  ...
  async patch(
    ...
    return this.paradaRepository.viajes(id).patch(viaje, where);
  }
  ...
  async delete(
    ...
    return this.paradaRepository.viajes(id).delete(where);
  }
}
