...
export class ClienteCalificacionConductorController {
  ...
  async find(
    ...
    return this.clienteRepository.calificacionConductors(id).find(filter);
  }
  ...
  async create(
    ...
    return this.clienteRepository.calificacionConductors(id).create(calificacionConductor);
  }
  ...
  async patch(
    ...
    return this.clienteRepository.calificacionConductors(id).patch(calificacionConductor, where);
  }
  ...
  async delete(
    ...
    return this.clienteRepository.calificacionConductors(id).delete(where);
  }
}
