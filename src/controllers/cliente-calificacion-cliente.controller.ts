...
export class ClienteCalificacionClienteController {
  ...
  async find(
    ...
    return this.clienteRepository.calificacionClientes(id).find(filter);
  }
  ...
  async create(
    ...
    return this.clienteRepository.calificacionClientes(id).create(calificacionCliente);
  }
  ...
  async patch(
    ...
    return this.clienteRepository.calificacionClientes(id).patch(calificacionCliente, where);
  }
  ...
  async delete(
    ...
    return this.clienteRepository.calificacionClientes(id).delete(where);
  }
}
