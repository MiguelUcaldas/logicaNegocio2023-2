...
export class CalificacionClienteController {
  ...
  @get('/calificacion-clientes/count')
  @response(200, {
  ...
  @patch('/calificacion-clientes/{id}')
  @response(204, {
